  ...
  var n = {
      256: (n, t, e) => {
          ...
          return "function" == typeof n
            ? (t = n) !== IDBDatabase.prototype.transaction ||
              ...
              ? (
                ...
                ? function (...n) {
                    return t.apply(m(this), n), g(u.get(this));
                  }
                : function (...n) {
                    return g(t.apply(m(this), n));
                  }
              : function (n, ...e) {
                  const r = t.call(m(this), n, ...e);
                  return f.set(r, n.sort ? n.sort() : [n]), g(r);
                }
        ...
        function g(n) {
          if (n instanceof IDBRequest)
            return (function (n) {
              ...
              return (
                t
                  .then((t) => {
                    t instanceof IDBCursor && u.set(t, n);
                  })
                  .catch(() => {}),
                p.set(t, n),
                t
          ...
          const t = v(n);
          return t !== n && (d.set(n, t), p.set(t, n)), t;
        }
        const m = (n) => p.get(n);
        function y(
          n,
          ...
          return (
            r &&
              i.addEventListener("upgradeneeded", (n) => {
                r(g(i.result), n.oldVersion, n.newVersion, g(i.transaction));
              }),
        ...
        (k = h),
          (h = {
            ...k,
            get: (n, t, e) => _(n, t) || k.get(n, t, e),
            has: (n, t) => !!_(n, t) || k.has(n, t),
          });
        var E = (function () {
            var n = o(
              i().mark(function n() {
                    ...
                    switch ((n.prev = n.next)) {
                      ...
                      case 3:
                        return (
                          ...
                          (a = o.put({ id: 1, value: t })),
                          (n.next = 9),
                          a
                        );
                      case 9:
                        (c = n.sent),
                          console.log("🚀 - data saved to the database", c);
                      case 11:
                      case "end":
                        return n.stop();
                    }
            ...
            (this.editor = CodeMirror(document.querySelector("#main"), {
              ...
              this.editor.on("blur", function () {
                console.log("The editor has lost focus"),
                  (0, a.d)(localStorage.getItem("content"));
              });
          });
      },
      426: (n, t, e) => {
  ...
  (e.n = (n) => {
    ...
    (() => {
      ...
      (j.styleTagTransform = S()),
        (j.setAttributes = w()),
        (j.insert = y().bind(null, "head")),
        (j.domAPI = g()),
        (j.insertStyleElement = k()),
        h()(L.Z, j),
      ...
      (P.innerHTML = ""),
        void 0 === new d.Z() &&
          ((I = document.createElement("div")).classList.add("spinner"),
          (I.innerHTML =
