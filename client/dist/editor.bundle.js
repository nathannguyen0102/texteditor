  ...
  var t = {
      256: (t, e, r) => {
          ...
          return "function" == typeof t
            ? (e = t) !== IDBDatabase.prototype.transaction ||
              ...
              ? (
                ...
                ? function (...t) {
                    return e.apply(y(this), t), v(s.get(this));
                  }
                : function (...t) {
                    return v(e.apply(y(this), t));
                  }
              : function (t, ...r) {
                  const n = e.call(y(this), t, ...r);
                  return f.set(n, t.sort ? t.sort() : [t]), v(n);
                }
        ...
        function v(t) {
          ...
          const e = d(t);
          return e !== t && (l.set(t, e), h.set(e, t)), e;
        }
        const y = (t) => h.get(t);
        function g(
          t,
          ...
          return (
            n &&
              a.addEventListener("upgradeneeded", (t) => {
                n(v(a.result), t.oldVersion, t.newVersion, v(a.transaction));
              }),
        ...
        (L = p),
          (p = {
            ...L,
            get: (t, e, r) => x(t, e) || L.get(t, e, r),
            has: (t, e) => !!x(t, e) || L.has(t, e),
          }),
          (function () {
            var t,
              e =
